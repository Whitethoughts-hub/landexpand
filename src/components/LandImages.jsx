...
import Img1 from "../assets/KeyBenefits/New-buildings.png";
import Img4 from "../assets/KeyBenefits/New-Hospital.jpg";
import { motion } from "framer-motion";
const FourShowcase = () => {
  return (
    <section className="w-full flex items-center justify-center">
      <div className="max-w-[1300px] w-full px-[10px] md:px-[40px] py-[50px] md:py-[100px] flex flex-col md:flex-row flex-wrap gap-6 md:gap-4 justify-center md:justify-between">
        {/* ITEM 1 */}{" "}
        <motion.h2
